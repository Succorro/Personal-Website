...
function Contact() {
  return (
    <div className="flex justify-center items-center px-16 py-12 bg-white max-md:px-5">
      <div className="mt-16 w-full max-w-[971px] max-md:mt-10 max-md:max-w-full">
        <div className="flex gap-5 max-md:flex-col max-md:gap-0 max-md:">
          <div className="flex flex-col w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow max-md:mt-10">
              <h1 className="text-5xl font-bold tracking-tight whitespace-nowrap leading-[52.08px] text-violet-950">
                Get in Touch
              </h1>
              ...
              <div className="flex gap-3.5 justify-between mt-7 text-lg whitespace-nowrap">
                ...
                <p className="flex-auto font-medium leading-[156%] text-violet-950">
                  stevengbmv@gmail.com
                </p>
              </div>
              <p className="bg-slate-200 p-0.5 mt-10 rounded-xl w-full"/>
              <h1 className="mt-12 text-2xl font-medium leading-8 whitespace-nowrap text-violet-950 max-md:mt-10">
          ...
          <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
            <div className="flex flex-col grow font-bold max-md:mt-10 max-md:max-w-full">
              <h1 className="text-5xl tracking-tight leading-[52.08px] text-violet-950 max-md:max-w-full">
                Send Me A Message
              </h1>
