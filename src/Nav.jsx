  ...
  return (
    <nav className="bg-cornflowerblue pt-1 p-1">
          ...
          <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-between">
            ...
            <div className="hidden sm:ml-6 sm:block">
              <div className="flex sm:ml-auto sm:mr-auto space-x-4">
                <Link className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-xl font-medium" to='/projects'>Projects</Link>
                <Link className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-xl font-medium" to="/resume">Resume</Link>
              </div>
            </div>
          </div>
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            <button type="button" className="p-1.5 relative rounded-full bg-gray-700 p-1 text-gray-300 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800">
      ...
      <div className={menuClick} id="mobile-menu">
        ...
        <Link className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-xl font-bold" to='/projects'>Projects</Link>
        <Link className="text-gray-300 hover:bg-gray-700 hover:text-white block rounded-md px-3 py-2 text-xl font-bold" to="/resume">Resume</Link>
        </div>
      </div>
    </nav>
  );
