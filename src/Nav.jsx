  ...
  function handleClick(link) {
    ...
    if(link !== 'home') {
      updatedState = {
        ...
        home: "text-slate-800  hover:underline rounded-md px-3 py-2 text-lg sm:text-xl font-bold transition-color duration-100"
      }
    } else {
      ...
      <div className="px-2 sm:px-6 mx-10 lg:mx-20 border border-2 border-t-0 border-b-0 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center sm:items-stretch sm:justify-end">
            ...
            <a href='https://docs.google.com/document/d/e/2PACX-1vSyhQZiSbwdl22MyLyUl2ViygTiA_BDse4dHQ8zWtHpUewE0wZDVeBIxAI_4Tjx3WUC5ShG_Ssmitm6/pub' className="text-slate-800  hover:underline rounded-md px-3 py-2 text-lg font-bold transition-color duration-100" target='_blank' rel='noopener noreferrer'>Resume</a>
          </div>
        </div>
      </div>
